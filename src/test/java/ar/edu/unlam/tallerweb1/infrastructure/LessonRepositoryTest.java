...
public class LessonRepositoryTest extends SpringTest {
    ...
    public void whenINeedToKnowAllTheAvailableClassesToSingInAsStudent() {
        ...
        session().save(lesson2);
        // Clase 3
        Clase lesson3 = data.createLesson(new Date(2023,11,10),new Date(2023,11,10), new Date(2023,11,10), detail, place, difficulty, discipline, professor, state);
        session().save(lesson3);
        // Clase 4
        Clase lesson4 = data.createLesson(new Date(2023,11,10),new Date(2023,11,10), new Date(2023,11,10), detail, place, difficulty, discipline, professor, state);
